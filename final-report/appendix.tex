...
%The algorithm for the intraprocedural analysis step is illustrated
%in algorithm~\ref
Algorithm~\ref{fig:interFlow} shows the context-insensitive
analysis described in Section~\ref{sec:analysis}, and algorithm~\ref{fig:csInterFlow}
the context-sensitive version of the analysis.
