...
Our analysis only performs \textit{explicit taint propagation}
...
Our analysis does not perform \textit{implicit taint propagation}
(control-flow propagation) is another type of taint propagation.
...
Our current implementation uses the pointer analysis
...
function for the \callt statement of the intraprocedural analysis.
